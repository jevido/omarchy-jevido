...
BarWidget {
  ...
  WidgetButton {
    ...
    onPressed: function(b) {
      // Right click used to walk the label formats, which meant the only way
      // to see the choice was to keep clicking past it. It opens the settings
      // instead, where the same list is a list.
